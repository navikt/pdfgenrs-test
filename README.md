...
Update the image version in `Dockerfile`:

`FROM ghcr.io/navikt/pdfgenrs:<version>`

The test workflow reads the image reference from the Dockerfile automatically.
